    ...
    public void displayDataInTable(Context context, TableLayout tableLayout) {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                int signalStrength = cursor.getInt(cursor.getColumnIndexOrThrow("SignalStrength"));
                int strength = cursor.getInt(cursor.getColumnIndexOrThrow("strength"));
...
//                row.addView(textViewId);
                ...
                textViewSignalStrength.setText("信号强度: " + signalStrength + " ");
